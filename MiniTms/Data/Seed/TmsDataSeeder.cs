...
/// <summary>
/// EF Core seed data aligned with docs/seed.sql (master data only; Trips start empty).
/// </summary>
public static class TmsDataSeeder
{
    internal static readonly DateTime SeedTimestamp = new(2026, 5, 23, 0, 0, 0, DateTimeKind.Unspecified);
    internal static readonly DateOnly SeedOrderDate = new(2026, 5, 23);
    ...
    private static void SeedRateCards(ModelBuilder modelBuilder)
    {
        modelBuilder.Entity<RateCard>().HasData(
